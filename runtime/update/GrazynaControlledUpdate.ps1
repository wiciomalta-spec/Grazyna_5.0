...
function Write-Log([string]$Level,[string]$Message){$line="[$Level] $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') $Message";Add-Content -LiteralPath $log -Value $line -Encoding UTF8;Write-Host $line}
