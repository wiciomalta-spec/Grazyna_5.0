# Utwórz skrypt monitoringu
$monitorScriptPath = "E:\Grazyna_5.0\scripts\MONITOR_SERVICES.ps1"
...
Write-Host "[MONITOR] ✅ Utworzono skrypt monitoringu: $monitorScriptPath" -ForegroundColor Green