...
export default function(data) {
  ...
  group('health', () => {
    ...
    healthDuration && healthDuration.add(r.timings.duration);
...
export function handleSummary(data) {
  ...
  return {
    'k6_results.json': JSON.stringify({ p95_ms:p95, p99_ms:p99, rps, error_pct:err }, null, 2),
    stdout: `\n=== GRAŻYNA 5.0 k6 Results ===\n p95: ${p95}ms | p99: ${p99}ms | RPS: ${rps} | Errors: ${err}%\n`,
  };
}
