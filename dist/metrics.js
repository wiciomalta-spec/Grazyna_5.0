...
try {
    register.registerMetric && register.registerMetric(httpRequests);
    register.registerMetric && register.registerMetric(httpRequestDuration);
    register.registerMetric && register.registerMetric(httpErrors);
    register.registerMetric && register.registerMetric(workerGauge);
}
catch (e) {
