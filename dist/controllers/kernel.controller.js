...
export const getKernelProfile = async (_req, res) => {
    res.json({ success: true, data: kernelService.getRuntimeProfile() });
};
export const getKernelBlueprint = async (_req, res) => {
    res.json({ success: true, data: kernelService.getBlueprint() });
};
export const getKernelDrivers = async (_req, res) => {
    res.json({ success: true, data: kernelService.getDrivers() });
};
export const adaptKernel = async (req, res) => {
...
//# sourceMappingURL=kernel.controller.js.map